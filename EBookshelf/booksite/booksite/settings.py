...
# SECURITY WARNING: keep the secret key used in production secret! Key removed, but can be found in GDrive. Place file to gitignore for the future. 
SECRET_KEY = ''

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['bukwrm.onrender.com', '127.0.0.1', 'localhost']
